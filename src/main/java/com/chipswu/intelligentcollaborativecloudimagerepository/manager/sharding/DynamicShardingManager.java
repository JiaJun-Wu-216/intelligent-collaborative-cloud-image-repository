package com.chipswu.intelligentcollaborativecloudimagerepository.manager.sharding;
...
import com.chipswu.intelligentcollaborativecloudimagerepository.model.enums.SpaceTypeEnum;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "cloud_image_repository." + tableName) // 确保前缀合法
        ...
        if (shardingRule.isPresent()) {
            ShardingRuleConfiguration currentRuleConfig = shardingRule.get().getConfiguration();
            List<ShardingTableRuleConfiguration> updatedRules = currentRuleConfig.getTables()
                    .stream()
                    .map(oldTableRule -> {
            ...
            currentRuleConfig.setTables(updatedRules);
