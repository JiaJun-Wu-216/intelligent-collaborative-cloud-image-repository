package com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.json.JSONUtil;
import com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket.disruptor.PictureEditEventProducer;
import com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket.model.PictureEditActionEnum;
import com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket.model.PictureEditMessageTypeEnum;
import com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket.model.PictureEditRequestMessage;
import com.chipswu.intelligentcollaborativecloudimagerepository.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) {
        ...
        User user = (User) attributes.get("user");
        Long pictureId = (Long) attributes.get("pictureId");
        // 根据消息类型处理消息（生成消息到 Disruptor 环形队列中）
